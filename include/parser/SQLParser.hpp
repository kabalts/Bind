...
// MSVC workaround: "TokenType" conflicts with something in the Windows SDK
// (E0757: constant 'TokenType' is not a type name).
// Renamed to TokType to avoid the ambiguity.
